...
Gem::Specification.new do |spec|
  ...
  spec.description   = " This gem generates nicer default views styled with Bootstrap via the `bootstrap_form` gem, so you have a bit of a better starting point for your app. "
